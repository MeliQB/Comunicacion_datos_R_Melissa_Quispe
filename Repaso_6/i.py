...
logging.basicConfig(level=logging.INFO, format='%(asctime)s %(levelname)s: %(message)s') #  que incluye la hora del registro, el nivel de registro (por ejemplo, "INFO") y el mensaje registrado. 
